...
import org.d3if2129.assessment.databinding.HomeFragmentBinding
import org.d3if2129.assessment.db.HewanDb
import org.d3if2129.assessment.model.Hewan
...
class HomeFragment : Fragment() {
    ...
    private fun showResult(result: Hewan?) {
        val forImg = binding.bar.text.toString().lowercase()
        val imgRes = resources.getIdentifier(forImg, "drawable", "org.d3if2129.assessment")
